    ...
    return (
        <footer className="relative bg-white dark:bg-[#0a0a0a] pt-24 pb-12 overflow-hidden transition-colors duration-500">
            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                {/* Pembungkus utama dibuat justify-center agar grid tidak rata kiri di layar lebar */}
                <div className="flex justify-center">
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20 w-full max-w-6xl">
                ...
                {/* Big Background Text (Aura Branding) Tetap di Tengah */}
